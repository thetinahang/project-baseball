  ...
  return (
    <Card className={classes.root} width="400px" key={product.id}>
      ...
      <CardActions className={classes.action}>
        <Button variant="contained" color="primary" className={classes.button} component={ Link } to={'api/v2/users/'+ product.product['user_id'] +'/products/' + product.product['id'] + '/keyterms'}>
          See more info
        </Button>
      </CardActions>
    </Card>
